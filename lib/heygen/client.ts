...
export const ENDPOINTS = {
  ...
  // Per-look status (training/creation): GET /v3/avatars/looks/{look_id} ->
  // { status: processing|completed|failed, preview_image_url, ... }. Verified
  // against the live OpenAPI spec (developers.heygen.com).
  avatarLookStatus: (lookId: string) =>
